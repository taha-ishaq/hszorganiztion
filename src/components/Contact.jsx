        ...
        {isDesktop ? (
          ...
          <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6">
            <input
              ...
              value={form.name}
              onChange={handleChange}
              className="p-4 rounded-lg text-gray-900 bg-white border border-gray-300 shadow-md"
              required
            />
            <input
              type="email"
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              className="md:col-span-2 p-4 rounded-lg text-gray-900 bg-white border border-gray-300 shadow-md"
              required
            ></textarea>
            <button
              type="submit"
              className="md:col-span-2 bg-orange-500 text-white font-semibold py-3 rounded-lg shadow-lg"
            >
              Send Message
            </button>
            {status && (
